            ...
            config = {
                "$schema": "https://opencode.ai/config.json",
                    ...
                    "agent":  {
                        ...
                        "slide-generator": {
                            "description": "Generate professional HTML slide presentations using modern web technologies and presentation frameworks from prepared content.",
                            "mode": "subagent",
                            "temperature": 0.2,
                            "tools": {
                                "write": True,
